...
CREATE TABLE items(
    ...
    description TEXT NOT NULL,
    id_items_types INT UNSIGNED NOT NULL,
	FOREIGN KEY (id_items_types) REFERENCES items_types(id_item_type)
	);

INSERT INTO items (item,cost,consumable,tradeable,weight,image,description,id_items_types)
